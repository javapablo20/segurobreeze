                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('pesquisarPlanos') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tipo" class="w-full p-2 border rounded border-blue-200"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="faixa_etaria" class="w-full p-2 border rounded border-blue-200"
                                style="background-color: #e0f2fe;">
                                <option value="">Selecione</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="preco_max" step="0.01" placeholder="Ex.: 500.00"
                                class="w-full p-2 border rounded border-blue-200" style="background-color: #e0f2fe;">
                        </div>

                        <!-- Benefícios -->
                        <div class="mb-4">
                            <label class="block text-gray-700">Benefício:</label>
                            <input type="text" name="beneficio" placeholder="Ex.: Internação, Pediatria"
                                class="w-full p-2 border rounded border-blue-200" style="background-color: #e0f2fe;">
                        </div>

                        <button type="submit"
                            class="bg-blue-500 text-white px-4 py-2 mt-4 rounded hover:bg-blue-600 transition-colors"
                                    ...
                                    <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4">
                                        @foreach ($resultados as $plano)
                                                            <div class="bg-white shadow-md rounded-lg p-4 border border-gray-200"
                                                                ...
                                                                <p><strong>Preço:</strong> <span class="text-gray-600">R$
                                                                        {{ number_format($plano->preco, 2, ',', '.') }}</span></p>
                                                            </div>
                                        @endforeach
                                    </div>
                    @else
