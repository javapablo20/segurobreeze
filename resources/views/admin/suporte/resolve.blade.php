...
<x-app-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4 p-4 bg-gray-100 border border-gray-300 rounded-md">
            ...
            <p class="text-gray-700">{{ $suporte->descricao }}</p>
            <!-- Supondo que 'mensagem' seja o campo que contém o texto original -->
        </div>
        ...
        <form action="{{ route('admin.suporte.resolve', $suporte->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="resolucao" name="resolucao" rows="4" class="mt-1 block w-full border-gray-300 rounded-md"
                    required></textarea>
            </div>
