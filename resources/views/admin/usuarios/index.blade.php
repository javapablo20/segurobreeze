<x-app-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4">
            <a href="{{ route('admin.usuarios.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-md">Novo
                Usuário</a>
        </div>
            ...
            <div class="mt-4">
                ...
                <form id="deleteForm" action="" method="POST">
                    ...
                    <button type="button" onclick="closeDeleteModal()"
                        class="px-4 py-2 bg-gray-300 text-black rounded-md ml-2">Cancelar</button>
                </form>
            </div>
        </div>
    </div>
