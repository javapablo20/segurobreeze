    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('admin.usuarios.update', $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="historicomedico" id="historicomedico" class="mt-1 block w-full p-2 border rounded-md"
                    rows="3" required>{{ old('historicomedico', $user->historicomedico) }}</textarea>
