<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="datanascimento" class="block mt-1 w-full" type="date" name="datanascimento"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="endereco" class="block mt-1 w-full" type="text" name="endereco" :value="old('endereco')"
                required placeholder="Seu endereço" />
        ...
        <div class="mt-4">
            ...
            <textarea id="historicomedico" class="block mt-1 w-full border-gray-300 rounded-md" name="historicomedico"
                rows="4">{{ old('historicomedico') }}</textarea>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required
                autocomplete="new-password" placeholder="Sua senha" />
