        ...
        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200 mb-8">
            <form method="POST" action="{{ route('suporte.update', $suporte->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="titulo" name="titulo" value="{{ old('titulo', $suporte->titulo) }}"
                        class="mt-2 p-3 w-full border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
                        required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="descricao" name="descricao" rows="4"
                        class="mt-2 p-3 w-full border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
                        required>{{ old('descricao', $suporte->descricao) }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="Em andamento" @if($suporte->status == 'Em andamento') selected @endif>Em andamento
                        </option>
                ...
                <div class="mt-6 flex justify-center gap-4">
                    <button type="submit"
                        class="bg-teal-500 text-white px-6 py-2 rounded hover:bg-teal-600 transition duration-300">
                        Atualizar Ticket
                    </button>
