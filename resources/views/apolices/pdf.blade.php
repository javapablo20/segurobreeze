...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            font-size: 14px;
            /* Fonte do corpo do documento reduzida */
        }
        ...
        .header h1 {
            font-size: 22px;
            /* Tamanho do título da apólice reduzido */
            color: #8B0000;
            /* Cor vermelho escuro */
            margin: 0;
        }
        ...
        .table {
            ...
            margin-bottom: 20px;
            font-size: 13px;
            /* Fonte das tabelas reduzida */
        }

        .table th,
        .table td {
            padding: 6px;
            /* Diminuído o espaçamento nas células */
        ...
        .table th {
            ...
            color: #8B0000;
            /* Cor vermelho escuro para os títulos da tabela */
        }

        .footer {
            font-size: 11px;
            /* Rodapé com fonte menor */
        }

        h2 {
            font-size: 18px;
            /* Tamanho do título das seções menor */
            color: #8B0000;
            /* Cor vermelho escuro */
        }
    </style>
